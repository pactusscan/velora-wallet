...
-keep class com.andrutstudio.velora.data.rpc.** { *; }
-keep class com.andrutstudio.velora.data.market.** { *; }

# Keep Retrofit Interfaces
-keep interface com.andrutstudio.velora.data.**ApiService { *; }
-keep interface com.andrutstudio.velora.data.**Service { *; }
